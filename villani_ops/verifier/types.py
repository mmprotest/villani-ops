...
class EvidenceItem:
    ...
    validates:list[str]=field(default_factory=list); provenance:str|None=None; selfValidation:bool=False; downstreamValidation:bool=False; sessionLocalOnly:bool=False
@dataclass
class DeliverableSpec:
    input_artifacts:list[str]=field(default_factory=list); required_files:list[str]=field(default_factory=list); required_output_files:list[str]=field(default_factory=list); required_edited_files:list[str]=field(default_factory=list); required_entrypoints:list[str]=field(default_factory=list); required_binaries:list[str]=field(default_factory=list); required_services:list[str]=field(default_factory=list); required_endpoints:list[str]=field(default_factory=list); required_generated_artifacts:list[str]=field(default_factory=list); required_performance_checks:list[str]=field(default_factory=list); required_downstream_commands:list[str]=field(default_factory=list); required_commands:list[str]=field(default_factory=list); required_functions:list[str]=field(default_factory=list); required_behavior:list[str]=field(default_factory=list); negative_constraints:list[str]=field(default_factory=list); allowed_edit_constraints:list[str]=field(default_factory=list); unknown_paths:list[str]=field(default_factory=list)
@dataclass
