...
class OpsToolContext:
    run_dir:Path; recorder:any; transcript:list[dict]; recent_events:list[dict]|None=None
...
def execute_tool_with_policy(state, tool_name:str, tool_input:dict, tool_use_id:str, context:OpsToolContext)->OpsToolResult:
    ...
    try:
        ...
        event_map={'ops_submit_classification':'classification_submitted','ops_submit_investigation':'investigation_submitted','ops_submit_plan':'plan_submitted','ops_submit_decomposition':'decomposition_submitted','ops_validate_decomposition':'decomposition_validation_completed','ops_select_execution_path':'execution_path_selected','ops_launch_candidates':'candidate_attempt_completed','ops_launch_subtasks':'subtask_attempt_completed','ops_integrate_subtasks':'integration_completed','ops_select_winner':'selection_completed','ops_finalize_run':'run_finalized'}
