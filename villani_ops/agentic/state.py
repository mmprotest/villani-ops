...
class OpsRunState(BaseModel):
    ...
    warnings:list[str]=Field(default_factory=list); recovery_count:int=0; last_error:str|None=None; last_tool_name:str|None=None; last_tool_input:dict|None=None
